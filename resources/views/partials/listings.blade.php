<div class="listings promoted">
    <div class="container containerless">
        <div class="scrollable">
            ...
            <table class="table is-fullwidth" attr-table="listing">
                <thead>
                <tr class="table-today">
                    ...
                    <th>
                        <div class="sortable" attr-name="launch_date">
                            Launch
                            <svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M3.67063 4.3848C3.70733 4.42033 3.75644 4.44938 3.81372 4.46945C3.871 4.48951 3.93475 4.5 3.99946 4.5C4.06417 4.5 4.12791 4.48951 4.1852 4.46945C4.24248 4.44938 4.29158 4.42033 4.32828 4.3848L7.92857 0.918371C7.97024 0.878389 7.99468 0.831559 7.99923 0.782969C8.00377 0.734379 7.98826 0.685887 7.95436 0.642762C7.92047 0.599637 7.86949 0.563529 7.80697 0.53836C7.74445 0.513191 7.67278 0.499924 7.59974 0.5L0.399176 0.5C0.326308 0.500201 0.2549 0.513638 0.192632 0.538868C0.130364 0.564097 0.079592 0.600164 0.0457757 0.643189C0.0119594 0.686214 -0.00362155 0.73457 0.000708374 0.783056C0.0050383 0.831542 0.0291153 0.878324 0.0703501 0.918371L3.67063 4.3848Z"/>
                    ...
                    <th class="display-desktop">
                        <div class="sortable" attr-name="votes">Votes
                            <svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M3.67063 4.3848C3.70733 4.42033 3.75644 4.44938 3.81372 4.46945C3.871 4.48951 3.93475 4.5 3.99946 4.5C4.06417 4.5 4.12791 4.48951 4.1852 4.46945C4.24248 4.44938 4.29158 4.42033 4.32828 4.3848L7.92857 0.918371C7.97024 0.878389 7.99468 0.831559 7.99923 0.782969C8.00377 0.734379 7.98826 0.685887 7.95436 0.642762C7.92047 0.599637 7.86949 0.563529 7.80697 0.53836C7.74445 0.513191 7.67278 0.499924 7.59974 0.5L0.399176 0.5C0.326308 0.500201 0.2549 0.513638 0.192632 0.538868C0.130364 0.564097 0.079592 0.600164 0.0457757 0.643189C0.0119594 0.686214 -0.00362155 0.73457 0.000708374 0.783056C0.0050383 0.831542 0.0291153 0.878324 0.0703501 0.918371L3.67063 4.3848Z"/>
                            </svg>
                ...
                @foreach($items as $key => $item)
                    <tr data-listingid="{{ $item->id }}">
                            ...
                            <div>
                                <div class="flex">
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="listing-name">Beep Staking</div>
                                    </div>
                                </div>
                                <div class="sticky-border"></div>
                            </div>
                        ...
                        <td class="ignore display-desktop">
                            <div class="flex">
                                @if ( $item->image )
                                    <img src="{{ $item->getImage($item->image) }}" alt="" height="24">
                                @endif
                        ...
                        <td>
                            <span class="network">
                                                <img src="{{ $item->chain->getImage($item->chain->image) }}">
                                            {{$item->chain->getSymbol($item->chain)}}
                            </span>
                        </td>

                        <td><span class="presale">
                                @if ($item->presale_link)
                        ...
                        <td>In 6 days</td>
                        <td class="display-desktop"><span class="votes">{{ $item->votes }}</span>
                        </td>
                        <td class="display-desktop">
                            <span class="votes green">
                                <svg width="8" height="4" viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <td class="display-desktop">
                            <a href="vote/{{ $item->id }}" class="button is-primary">
                                </small><span>Vote</span>
                            </a>
                        </td>
                        <td class="ignore has-wishlist">
        ...
        <div class="pages">
            <nav class="pagination is-centered" role="navigation" aria-label="pagination">
                ...
                <ul class="pagination-list">
                    ...
                    <li>
                        <a href="/?page=3" class="pagination-link"
                           aria-label="Goto page 3">3</a>
                    </li>
                    <li>
                        <a href="/?page=4" class="pagination-link"
                           aria-label="Goto page 4">4</a>
                    </li>
                    <li>
                        <a href="/?page=5" class="pagination-link"
                           aria-label="Goto page 5">5</a>
                    </li>
                    <li>
                        <a href="/?page=6" class="pagination-link"
                           aria-label="Goto page 6">6</a>
                    </li>
                    <li>
                        <a href="/?page=7" class="pagination-link"
                           aria-label="Goto page 7">7</a>
                    </li>
                    <li>
                        <a href="/?page=8" class="pagination-link"
                    ...
                    <li>
                        <a href="/?page=275" class="pagination-link"
                           aria-label="Goto page 275">275</a>
                    </li>
                    <li>
                        <a href="/?page=276" class="pagination-link"
                           aria-label="Goto page 276">276</a>
                    </li>
